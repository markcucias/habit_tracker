...
def retrieve_habits():
    habits = [row[0] for row in db.get_all_active_habits()]
...
def delete_habit_route():
    ...
    habit_row = db.get_habit_by_name(habit)
    if not habit_row:
